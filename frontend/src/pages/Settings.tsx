...
import { User, Shield, Bell, Lock, Download, Trash2, Eye, EyeOff, Check, X } from 'lucide-react'
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-xl font-bold"
              style={{ background: 'linear-gradient(135deg, #C9A84C, #9A7A35)', color: '#050D0A', fontFamily: 'Space Grotesk, sans-serif' }}>
              {user?.email?.slice(0, 2).toUpperCase() || 'AE'}
            </div>
            <div>
              <p className="text-sm font-medium text-text-primary">{user?.email}</p>
              <p className="text-xs text-text-secondary mt-0.5">Avatar is auto-generated from your initials</p>
            </div>
          </div>
          ...
          <div>
            ...
            {user?.platforms_connected && user.platforms_connected.length > 0 ? (
              ...
              <p className="text-sm text-text-secondary">No platforms connected. <a href="/monitoring" className="text-teal hover:text-teal-mid">Add platforms →</a></p>
            )}
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card-static">
        ...
        <p className="text-text-secondary text-sm mb-5 leading-relaxed">Use an authenticator app (Google Authenticator, Authy) for maximum security. SMS 2FA can be SIM-swapped.</p>
        <div className="p-4 rounded-xl mb-4" style={{ background: 'rgba(34,197,94,0.05)', border: '1px solid rgba(34,197,94,0.15)' }}>
          ...
          <p className="text-xs text-text-secondary">Enable 2FA on each platform through their security settings. Use the Recovery section to get platform-specific guides.</p>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card-static">
        ...
        <p className="text-text-secondary text-sm mb-5">Export everything AEFORYN holds about you as a single JSON file. This includes your profile, threats, scan history, and more.</p>
...
export default function Settings() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      {/* Tabs */}
      <div className="flex items-center gap-1 mb-8 p-1 rounded-2xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(45,212,191,0.08)' }}>
        {TABS.map(({ id, label, icon: Icon }) => (
          <button
            ...
            style={{
              background: activeTab === id ? '#0C1A0F' : 'transparent',
